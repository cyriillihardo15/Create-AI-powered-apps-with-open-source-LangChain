...
openai_api_key = "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"
...
prompt = PromptTemplate(
    ...
    template="Yang terhormat HRD Manajer {Hoyoverse},\n\nDengan surat ini, saya Cyriil, ingin melamar untuk posisi {posisi} di {perusahaan}. Saya memiliki pengalaman di bidang {keterampilan}. Terima kasih telah mempertimbangkan lamaran saya.\n\nHormat saya,\n[NAMA KAMU]",
)
